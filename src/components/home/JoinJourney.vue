  ...
  <section id="join" class="join-threshold" aria-labelledby="join-title">
    ...
    <div class="join-threshold__content">
      ...
      <div class="join-actions">
        ...
        <a class="guide-link" href="https://discord.com/invite/jc7GSxBWgb" target="_blank" rel="noopener noreferrer">Join the Discord <span aria-hidden="true">↗</span></a>
      </div>
...
.copy-feedback { min-height:1.2em; margin:8px 0 0; color:rgba(252,249,242,.72); font:500 .54rem/1.4 "IBM Plex Mono",monospace; }.join-actions { display:flex; flex-wrap:wrap; align-items:center; gap:6px 28px; }.guide-link { display:inline-flex; align-items:center; gap:8px; min-height:44px; margin-top:12px; color:#f1cf91; font-size:.76rem; font-weight:750; }.guide-link span { font-size:1.1rem; }.join-note { margin:24px 0 0; color:rgba(252,249,242,.76); font-size:13px; line-height:1.5; }
