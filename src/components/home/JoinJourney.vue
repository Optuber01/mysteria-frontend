...
<style scoped>
.join-threshold { position: relative; min-height: 100svh; display: grid; place-items: center; overflow: hidden; padding: 110px 0 88px; color: var(--ink, #221c14); background: transparent; isolation: isolate; }
...
.join-threshold__content { width: min(620px, calc(100% - var(--home-rail-inset, clamp(20px, 4vw, 56px)) - var(--home-rail-inset, clamp(20px, 4vw, 56px)))); justify-self: start; margin-left: var(--home-rail-inset, clamp(20px, 4vw, 56px)); }
...
@media (max-width:760px) { .join-threshold { min-height:auto; padding:96px var(--home-content-gutter, 20px) 68px; }.join-threshold__content { width:100%; margin-left:0; }.orbit-arrival { position:relative; top:auto; left:auto; width:100%; height:58px; margin:16px 0 0; transform:none; opacity:.85; }.orbit-arrival__line { width:72%; margin-top:18px; }.orbit-arrival__seal { top:0; right:0; width:54px; height:54px; }.orbit-arrival p { top:4px; right:68px; }.orbit-arrival strong { font-size:1.45rem; }.join-threshold h2 { font-size:clamp(3rem,13vw,4.6rem); }.join-intro { font-size:.84rem; }.join-guide { margin-top:26px; }.copy-address strong { overflow-wrap:anywhere; } }
